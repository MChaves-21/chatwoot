...
export const BPC_COLUMNS = [
  ...
  /*
   * 15/09/2026 — sairam as colunas de ORIGEM "Closer ChatGuru"
   * (chatguru_closer) e "SDR ChatGuru" (chatguru_sdr), criadas em 13/08 para
   * os 428 leads migrados do ChatGuru. A equipe ja distribuiu todos: na API,
   * nenhuma conversa (status=all, todas as caixas) tinha mais essas etiquetas.
